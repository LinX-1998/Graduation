...
from util.ui_function import model_check, model_compare, new_start
...
combobox_model_1["value"] = ("--请选择--",
                             "SPE+LR", "RUS+LR", "SMOTE+LR", "SMOTEENN+LR",
                             "SPE+DT", "RUS+DT", "SMOTE+DT", "SMOTEENN+DT",
                             "SPE+MLP", "RUS+MLP", "SMOTE+MLP", "SMOTEENN+MLP",
                             "SPE+RF", "RUS+RF", "SMOTE+RF", "SMOTEENN+RF")
...
list_value.set(("拍拍贷全量数据", "信用卡全量数据"))
