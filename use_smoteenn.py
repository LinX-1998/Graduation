...
"""
    ...
    @file: use_smoteenn.py
    @time: 2020/4/20 21:15
...
from sampling_train.SMOTEENN import SmoteEnn
...
def parse():
    ...
    parser.add_argument("--method", type=str, default="SMOTEENN", help="Sampling methods")
