...
from sampling_train.SelfPacedEnsemble import SelfPacedEnsemble
...
def parse():
    ...
    parser.add_argument("--method", type=str, default="SPE", help="Sampling methods")
    parser.add_argument("--n_estimators", type=int, default=15, help="Number of base estimators")
